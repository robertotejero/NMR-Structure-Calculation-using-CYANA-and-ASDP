...
### Results
  All output files neccessary for PDB validation could be found in [HERE](https://github.com/Nucleus2014/NMR-Structure-Calculation-using-CYANA-and-ASDP/tree/master/output/CYANA). The report for result could be generated by [PSVS](http://psvs-1_5-dev.nesg.org/) mentioned in the first part.  
